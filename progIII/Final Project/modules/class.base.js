module.exports = class Base {
    ...
    chooseCell(character, tes, gend = undefined) {
        ...
        if (newCre) {
            ...
            switch (mulArr) {
                case grassArr:
                    ...
                    break;
                case grasseaterArr:
                    grasseaterArr.push(new GrassEater(newCre[0], newCre[1], 2, gend()));
                    break;
                case wolfArr:
                    wolfArr.push(new Wolf(newCre[0], newCre[1], 3, gend()));
                    break;
                case poisonerArr:
                ...
                case humanArr:
                    ...
                    break;
                case catArr:
                    catArr.push(new Cat(newCre[0], newCre[1], 6, gend()));
            }
        }
        this.tact++;
        if(this.tact <= 10){
